...
const CompanyItem = ({ t, data }) => {
  ...
  return (
    <div className='company-item-root'>
      ...
      { data.cover !== null ? <img src={`${serverFileURL}${data.cover}`} className='company-item-root-cover' /> : <div className='company-item-root-cover'></div>}
      { data.logo !== null ? <img src={`${serverFileURL}${data.logo}`} className='company-item-root-logo' /> : <div className='company-item-root-logo'></div> }
