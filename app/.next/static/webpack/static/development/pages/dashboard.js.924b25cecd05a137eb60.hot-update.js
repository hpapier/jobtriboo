...
var DashboardBody = function DashboardBody() {
  ...
  return __jsx("div", {
    ...
    type: "number",
    onChange: function onChange(e) {
      return e.target.value <= 15 ? setMinSalary(15) : setMinSalary(e.target.value);
    },
    value: minSalary,
    style: {
      margin: 5
    ...
    type: "number",
    onChange: function onChange(e) {
      return e.target.value <= minSalary ? setMaxSalary(minSalary) : setMaxSalary(e.target.value);
    },
    value: maxSalary,
    style: {
      margin: 5
...
//# sourceMappingURL=dashboard.js.924b25cecd05a137eb60.hot-update.js.map